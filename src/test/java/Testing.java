...
public class Testing {
    ...
    public void testDCPABE2() {
        ...
        attributes[0] = new Attributes("a0", "a0_1", "a0_2", "a0_3");
        attributes[1] = new Attributes("a1", "a1_1", "a1_2", "a1_3");

        AuthorityKeys authority1 = DCPABE.authoritySetup("a1", gp, attributes);
        publicKeys.subscribeAuthority(authority1.mapOf_AA_PK);
